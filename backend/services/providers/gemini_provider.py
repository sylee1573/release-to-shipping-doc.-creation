...
class GeminiProvider(BaseAIProvider):
    ...
    def __init__(self):
        ...
        self.model_heavy = genai.GenerativeModel(os.getenv("GEMINI_MODEL_HEAVY", "gemini-1.5-pro"))
        self.model_light = genai.GenerativeModel(os.getenv("GEMINI_MODEL_LIGHT", "gemini-1.5-flash"))
