...
- quantity: 이번 납품 수량 (숫자만; SA Release는 가장 가까운 미래 납기의 Volume 선택, Progress/CUM 제외)
- unit: 단위 (항상 "EA"로 통일)
